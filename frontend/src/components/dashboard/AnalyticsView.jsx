    ...
    <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 custom-scrollbar bg-background">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-white/10">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 text-slate-200 font-semibold text-xs border border-white/10 transition-all"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-card p-5 rounded-2xl border border-white/10">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-xs font-medium uppercase tracking-wider text-slate-400">Avg RAG Latency</p>
              <h3 className="text-3xl font-extrabold text-white mt-1">420 <span className="text-sm font-normal text-slate-400">ms</span></h3>
            </div>
        ...
        <div className="glass-card p-5 rounded-2xl border border-white/10">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-xs font-medium uppercase tracking-wider text-slate-400">Vector Search Speed</p>
              <h3 className="text-3xl font-extrabold text-teal-400 mt-1">18 <span className="text-sm font-normal text-slate-400">ms</span></h3>
            </div>
        ...
        <div className="glass-card p-5 rounded-2xl border border-white/10">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-xs font-medium uppercase tracking-wider text-slate-400">Primary Model</p>
        ...
        <div className="glass-card p-5 rounded-2xl border border-white/10">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-xs font-medium uppercase tracking-wider text-slate-400">DB Records</p>
          ...
          <div className="space-y-3 text-xs">
            <div className="p-3.5 rounded-xl bg-secondary border border-border space-y-1">
              <div className="flex justify-between font-semibold">
                ...
                <span className="text-emerald-400">30 Chunks</span>
              </div>
